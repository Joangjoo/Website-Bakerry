...
if ($result && $result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $categories[$row['jenis']][] = $row;
    }
}
$conn->close();
?>
<script>
    const categories = <?php echo json_encode($categories, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
...
<body class="bg-primary">
    ...
    <!-- Section Header -->
    <section class="mt-[17rem] flex items-center justify-center gap-20 header relative ">
        <div class="ml-40">
            <h1 class="text-5xl font-bold text-pink-600 w-96 mb-3" data-aos="flip-left" data-aos-duration="3000">Pesan sekarang dan rasakan manisnya kue kami!</h1>
            <p class="text-base w-[28rem] text-justify text-text opacity-90 mb-3" data-aos="flip-left" data-aos-duration="3000" data-aos-delay="300">Lorem ipsum dolor, sit amet consectetur adipisicing elit. In, est, neque adipisci asperiores, suscipit odio culpa nam explicabo sapiente vel provident hic natus doloribus itaque nesciunt sunt excepturi consequuntur? Culpa!</p>
            <button class="relative bg-gradient-to-r from-pink-500 via-white to-pink-500 bg-[length:200%_100%] w-48 h-12 rounded-full font-semibold text-black transition-all duration-300 hover:animate-shimmer">Explore Menu</button>
        </div>
        <div data-aos="flip-left" data-aos-duration="3000" data-aos-delay="500">
            <img src="../public/assets/kue/KueHeader.png" alt="">
        </div>
        <div class="absolute bottom-0 left-0 w-full -z-20">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#ffafcc" fill-opacity="1" d="M0,160L48,133.3C96,107,192,53,288,37.3C384,21,480,43,576,53.3C672,64,768,64,864,90.7C960,117,1056,171,1152,170.7C1248,171,1344,117,1392,90.7L1440,64L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
            </svg>
        </div>
    </section>
    <!-- Section Header End-->
    ...
    <!-- Section main -->
    <section class="flex items-center justify-around gap-10 mt-24 relative h-[35rem]">
        <div class="ml-16">
            <h1 class="text-4xl text-text font-bold mb-10" data-aos="zoom-in" data-aos-duration="3000">Redy Mengantarkan Dimana Saja</h1>
            <p class="text-text opacity-90 w-[30rem] mb-5" data-aos="zoom-in" data-aos-duration="3000" data-aos-delay="200">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Culpa facilis architecto quasi vero repudiandae recusandae, veritatis sapiente perferendis voluptas vitae cupiditate dolorem nihil eum libero voluptatibus enim totam possimus autem eveniet nobis non repellendus sit. Corrupti illum accusamus odit quo!</p>
            <div class="flex gap-5">
                <div data-aos="zoom-in" data-aos-duration="3000" data-aos-delay="500">
                    <button class="relative bg-gradient-to-r from-button via-white to-button bg-[length:200%_100%] w-36 h-12 rounded-full font-semibold text-black transition-all duration-300 hover:animate-shimmer">Contact Us</button>
                </div>
                <div data-aos="zoom-in" data-aos-duration="3000" data-aos-delay="700">
                    <button class="relative bg-gradient-to-r from-pink-500 via-white to-pink-500 bg-[length:200%_100%] w-36 h-12 rounded-full font-semibold text-black transition-all duration-300 hover:animate-shimmer">View Menu</button>
                </div>
            </div>
            <div class="flex mt-6 gap-10 cursor-pointer">
                <div class="bg-white w-44 text-center py-2 rounded-full" data-aos="zoom-in" data-aos-duration="3000" data-aos-delay="900">
                    <i class='bx bxs-shopping-bag-alt bg-pink-300 py-2 px-2 rounded-full'></i>
                    <span>Online Order</span>
                </div>
                <div class="bg-white w-44 py-2 rounded-full text-center" data-aos="zoom-in" data-aos-duration="3000" data-aos-delay="1100">
                    <i class='bx bxs-bell bg-pink-300 py-2 px-2 rounded-full'></i>
                    <span>Reservasi</span>
                </div>
            </div>
        </div>
        <div class="mr-11" data-aos="zoom-in" data-aos-duration="3000" data-aos-delay="300">
            <img src="../public/assets/kue/kue2.png" alt="" class="w-[80%]">
        </div>
        <div class="absolute bottom-0 left-0 w-full -z-10">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#f8d7e2" fill-opacity="1" d="M0,256L40,218.7C80,181,160,107,240,74.7C320,43,400,53,480,69.3C560,85,640,107,720,122.7C800,139,880,149,960,160C1040,171,1120,181,1200,197.3C1280,213,1360,235,1400,245.3L1440,256L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
            </svg>
        </div>
    </section>
    <!-- Section Main End -->
    ...
    <div class="mx-auto mt-24 max-w-6xl">
        <h1 class="text-5xl font-bold text-center text-red-500 mb-10">Kue Kami</h1>

        <div class="flex gap-8 justify-center items-start">
            <!-- Sidebar -->
            <div class="bg-red-500 text-white p-4 rounded-lg w-1/4">
                <ul class="space-y-4">
                    <li class="cursor-pointer bg-white text-black px-4 py-2 rounded-lg hover:bg-red-300" data-category="birthday">
                        Birthday Cake
                    </li>
                    <li class="cursor-pointer bg-white text-black px-4 py-2 rounded-lg hover:bg-red-300" data-category="donut">
                        Donut
                    </li>
                    <li class="cursor-pointer bg-white text-black px-4 py-2 rounded-lg hover:bg-red-300" data-category="chocolate">
                        Chocolate Bar
                    </li>
                    <li class="cursor-pointer bg-white text-black px-4 py-2 rounded-lg hover:bg-red-300" data-category="snacks">
                        Snacks
                    </li>
                </ul>
            </div>
            <!-- Konten -->
            <div id="content-container" class="flex flex-wrap gap-6 justify-center w-3/4"></div>
        </div>
    </div>
    <!-- Kue Scroll End-->

    <!-- Section Baru -->
    <section class="relative py-16 bg-gradient-to-r from-pink-100 via-white to-pink-100 overflow-hidden">
        <div class="absolute inset-0">
            <svg class="absolute top-0 left-0 w-full h-auto opacity-70" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" transform="scale(1, -1)">
                <path fill="#ffafcc" fill-opacity="1" d="M0,128L60,154.7C120,181,240,235,360,240C480,245,600,203,720,165.3C840,128,960,96,1080,101.3C1200,107,1320,149,1380,170.7L1440,192L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
            </svg>
            <svg class="absolute bottom-0 left-0 w-full h-auto opacity-70" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" #1715430>
                <path fill="#f8d7e2" fill-opacity="1" d="M0,224L60,218.7C120,213,240,203,360,186.7C480,171,600,149,720,128C840,107,960,85,1080,96C1200,107,1320,149,1380,170.7L1440,192L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
            </svg>
        </div>

        <div class="relative max-w-7xl mx-auto px-6">
            <h1 class="text-5xl font-extrabold text-center text-pink-800 mb-8 drop-shadow-lg">
                Roti Yang Lembut Di Makan Dan Enakk
            </h1>
            <?php
            $limitedData = array_slice($categories, 0, 4);
            ?>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-center">
                <?php
                $animation = "fade-up";
                $index = 0;
                foreach ($limitedData as $jenis => $items):
                    foreach (array_slice($items, 0, 1) as $item):
                        $delay = $index * 200;
                ?>
                        <div class="m-2 group px-10 py-5 bg-white/10 rounded-lg flex flex-col items-center justify-center gap-2 relative after:absolute after:h-full after:bg-pink-600 z-10 shadow-lg after:-z-20 after:w-full after:inset-0 after:rounded-lg transition-all duration-300 hover:transition-all hover:duration-300 after:transition-all after:duration-500 after:hover:transition-all after:hover:duration-500 overflow-hidden cursor-pointer after:-translate-y-full after:hover:translate-y-0 [&_p]:delay-200 [&_p]:transition-all" data-aos=<?= $animation ?> data-aos-delay=<?= $delay ?>>
                            <img src="<?= htmlspecialchars($item['image']) ?>" alt="<?= htmlspecialchars($item['title']) ?>" class="w-24">
                            ...
                            <div class="ordernow flex flex-row justify-between items-center w-full">
                                ...
                                <a href="order.php?id_jenis=<?= urlencode($item['id_roti']) ?>">
                                    <p class="btun4 lg:inline-flex items-center gap-3 group-hover:bg-pink-800 bg-pink-600 shadow-[10px_10px_150px_#f78db3] cursor-pointer py-2 px-4 text-sm font-semibold text-white rounded-full butn transition-all">
                                        Order Now
                                    </p>
                                </a>
            ...
            <div class="text-center mt-16">
                <a href="menu.php">
                    <button class="bg-pink-600 text-white font-semibold text-lg px-10 py-4 rounded-full hover:bg-pink-700 shadow-lg hover:shadow-2xl transition-all duration-300">
                        Shop Now
                    </button>
                </a>
            </div>
