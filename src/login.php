...
<body>
  <div class="flex justify-center items-center font-[sans-serif] h-full min-h-screen p-4"
    style="background: linear-gradient(180deg, #f5e6da 0%, #d2b48c 100%); position: relative;">
    <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 0; overflow: hidden;">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" style="width: 100%; height: auto;">
        <path fill="#ffffff" fill-opacity="1" d="M0,96L60,112C120,128,240,160,360,186.7C480,213,600,235,720,224C840,213,960,171,1080,144C1200,117,1320,107,1380,101.3L1440,96L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
      </svg>
    </div>

    <div class="max-w-md w-full mx-auto z-10">
      <form action="action/action_login.php" method="POST" class="bg-opacity-70 bg-white rounded-2xl p-6 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]">
        <div class="mb-12">
        ...
        <div>
          <div class="relative flex items-center">
            ...
            <i class='bx bxs-envelope absolute right-2 text-gray-800 text-xl'></i>
          </div>
        </div>
        ...
        <div class="mt-6">
          <div class="relative flex items-center">
            ...
            <i class='bx bx-low-vision absolute right-2 text-gray-800 text-xl cursor-pointer'></i>
          </div>
        </div>
        ...
        <div class="mt-12">
          ...
          <p class="text-gray-800 text-sm text-center mt-6">Don't have an account <a href="register.php"
