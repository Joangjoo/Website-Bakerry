...
<body>
  <div class="flex justify-center items-center font-[sans-serif] h-full min-h-screen p-4"
    ...
    <div class="max-w-md w-full mx-auto z-10">
      <form action="action/action_regis.php" method="POST" class="bg-opacity-70 bg-white rounded-2xl p-6 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]">
        <div class="mb-12">
        ...
        <div class="mt-6">
          <div class="relative flex items-center">
            ...
            <div class="error-message" id="emailError"></div>
            <i class='bx bxs-user absolute right-2 text-gray-800 text-xl cursor-pointer'></i>
          </div>
        </div>
